...
<div id="wrapper">
  ...
  <nav class="navbar navbar-default navbar-cls-top" role="navigation" style="margin-bottom: 0">
   ...
   if(($epf_noNob==$_POST['epf_no']) || ($chkpfno<>$_POST['epf_no'])){
       ...
       function get_trxn_dtl_max()
        ...
        $posIdNob         = $_SESSION['positionUp'];  
        $enameNob         = $_SESSION['enameUp'];  
        $addressNob       = $_SESSION['addressUp'];  
        $dobNob           = $_SESSION['dobUp'];  
        $genderNob        = $_SESSION['genderUp'];  
        $tel_plNob        = $_SESSION['tel_personalUp'];  
        $tel_homeNob      = $_SESSION['tel_homeUp'];  
        $nicNob           = $_SESSION['nicUp'];
        $religionNob      = $_SESSION['religionUp'];
        $ciilstusNob      = $_SESSION['civilstatusUp'];
        $catgroyNob       = $_SESSION['catogaroyUp'];  
        $devIdNob         = $_SESSION['devisionUp'];  
        $teamIdNob        = $_SESSION['teamUp'];  
        $imageNob         = $_SESSION['ephotoUp'];  
        $eduIdNob         = $_SESSION['minimum_eduUp'];  
        $sportsNob        = $_SESSION['sportsUp'];  
        $extra_eduNob     = $_SESSION['extra_eduUp'];  
        $e_dojNob         = $_SESSION['e_dojUp'];  
        $ocompanyNob      = $_SESSION['other_companyUp'];   
        $occupationNob    = $_SESSION['occupationUp'];  
        $time_periodNob   = $_SESSION['etime_periodUp'];  
        $remarksNob       = $_SESSION['remarksUp']; 
  ...
  if($_SESSION['pCheck'] == 2 OR $_SESSION['pCheck'] == 3 OR $_SESSION['pCheck'] == 4 OR $_SESSION['pCheck'] == 5){

                      $olNob = $_SESSION['over_lockUp'];
                      $flNob = $_SESSION['flat_lockUp'];
                      $snNob = $_SESSION['single_needleUp'];
                      $dnNob = $_SESSION['double_needleUp'];
                      $btNob = $_SESSION['bar_tackUp'];
                      $bhNob = $_SESSION['button_holeUp'];
                      $baNob = $_SESSION['button_attachUp'];
                      $piNob = $_SESSION['picotUp'];
        ...
        if($_SESSION['pCheck'] <> 2 AND $_SESSION['pCheck'] <> 3 AND $_SESSION['pCheck'] <> 4 AND $_SESSION['pCheck'] <> 5){

           $value  = $_SESSION['pCheck'];
        } else{
        ...
        if( ($_SESSION['pCheck']== $value AND ( $_POST['position']== 2 OR 
                                                $_POST['position']== 3 OR 
                                                $_POST['position']== 4 OR 
                                                $_POST['position']== 5 ))  ) {
     ...
     //  }
       ...
       if($oSRow['emp_id']==$empId){
            ...
            $SQLCheck = "UPDATE `skill` SET 
             ...
             if($_FILES && $_FILES["file"]["size"] < $FileSize) {
                  ...
                  if("../images/employee/noimage/noimage.png"!==$_SESSION['oldImageName']){

                 
                     file_exists($_SESSION['oldImageName']);
                      unlink($_SESSION['oldImageName']);
                  }
      ...
      if ($con->query($SUpdate)===TRUE) {
        ...
        if(($_SESSION['pCheck'] == 2 AND $_POST['position']== 2) OR
           ($_SESSION['pCheck'] == 3 AND $_POST['position']== 3) OR
           ($_SESSION['pCheck'] == 4 AND $_POST['position']== 4) OR 
           ($_SESSION['pCheck'] == 5 AND $_POST['position']== 5)){
              ...
              <div class="row">
               <div class="col-md-2">
                 ...
                 <div class="col-md-8 text-center">
                    <h1>Dear Admin &nbsp;<strong><?php echo $_SESSION['adminSession']; ?></strong></h1>
