  ...
  <nav class="navbar navbar-default navbar-cls-top" role="navigation" style="margin-bottom: 0">
    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            ...
            $moreSQL  = "SELECT * FROM `noti_news` WHERE `active_id` = '$dtlId'";
              ...
              while($moreRow= mysqli_fetch_assoc($moreQuery))
            {
                   ...
                   $news_id    = $moreRow['news_id'];
                   $heading    = $moreRow['heading'];
                   $content    = $moreRow['content'];
            ...
            <div class="row">
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr><td id="colorTd">ID</td>                   <td><?php echo $news_id; ?></td></tr>
                    <tr><td id="colorTd">Header</td>               <td><?php echo $heading; ?></td></tr>
                    <tr><td id="colorTd">Content</td>              <td><?php echo $content; ?></td></tr>
                    <tr><td id="colorTd">Active / Inactive</td>    <td><?php echo $active; ?></td></tr> 
                  </tbody>
                </table>
              </div> 
        </div>
