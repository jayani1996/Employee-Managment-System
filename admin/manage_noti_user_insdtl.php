  ...
  <nav class="navbar navbar-default navbar-cls-top" role="navigation" style="margin-bottom: 0">
    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            ...
            $moreSQL  = "SELECT * FROM `noti_user` WHERE `active_id` = '$dtlId'";
              ...
              while($moreRow= mysqli_fetch_assoc($moreQuery))
            {
                   ...
                   $user_id     = $moreRow['user_id'];
                   $epf_no      = $moreRow['epf_no'];
                   $username    = $moreRow['username'];
                   $password    = $moreRow['password'];
                   $cateId      = $moreRow['category'];
                   $userLvl     = $moreRow['user_level'];
            ...
            <div class="row">
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr><td id="colorTd">ID</td>          <td><?php echo $user_id; ?></td></tr>
                    <tr><td id="colorTd">EPF No</td>      <td><?php echo $epf_no; ?></td></tr>
                    <tr><td id="colorTd">Username</td>    <td><?php echo $username; ?></td></tr>
                    <tr><td id="colorTd">Password</td>    <td><?php echo $password; ?></td></tr>
                    <tr><td id="colorTd">Category</td>    <td><?php echo $cateNa;  ?></td></tr> 
                    <tr><td id="colorTd">User Level</td>  <td><?php echo $lvlNa;  ?></td></tr> 
                  </tbody>
                </table>
              </div> 
        </div>
