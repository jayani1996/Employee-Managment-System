          ...
          <div class="row">
            <div class="col-md-12 col-lg-12 text-center">
              <h3>
                ...
                <strong style="color:green">Manage Employee</strong>
              </h3>
            </div>
          </div>
          <hr/> 
          <div class="row">
            <div class="col-md-2 col-lg-2">
             ...
             <div class="col-md-9 col-lg-9 text-center">
              ...
              <h3><span style="color:green">Employee has been Registered.</span></h3>
          </div>
          </div>
          <hr/>
            <?php 
             $sql_query_img ="SELECT * FROM employee WHERE `emp_id` = '$empId' AND `active_id` = '$trxnDtlid' ";
             $sql = mysqli_query($con,$sql_query_img);
              ...
              <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr><td id="colorTd">Service Period</td>               <td><?php echo $time_period; ?></td></tr>
                  ...
                  <?php
                        ...
                        if($posId =="2" OR $posId =="3" OR $posId =="4" OR $posId =="5"){
                          ...
                          $sql_supper ="SELECT * FROM `skill` WHERE `emp_id` = '$empId' AND `active_id` = '$trxnDtlid'";
