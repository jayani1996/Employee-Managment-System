        ...
        <div class="sidebar-collapse">
            ...
            if($numOfRows >0)
            {
                while($row= mysqli_fetch_assoc($sql_select)){
                       ...
                       $_SESSION['hrpCheck'] = $row['position'];
                       $_SESSION['hremployeeID']   = $row['emp_id'];
                       $eid          = $row['emp_id'];
                       $epf_no       = $row['epf_no']; 
                       $posId        = $row['position'];
                       $ename        = $row['ename'];
                      ...
                      $_SESSION['hroldImageName'] ="../images/employee/noimage/".$row['ephoto'];
                     }else{

                      $image = "../images/employee/".$row['ephoto'];
                      
                      $_SESSION['hroldImageName']  = "../images/employee/".$row['ephoto'];
                      ...
                      $days   = floor(($diff - $years * 365*60*60*24 - $months*30*60*60*24)/ (60*60*24));
                       ...
                       $_SESSION['hrepf_noUp']         = $epf_no; 
                       $_SESSION['hrpositionUp']       = $posId;
                       $_SESSION['hrenameUp']          = $ename;
                       $_SESSION['hraddressUp']        = $address;
                       $_SESSION['hrdobUp']            = $dob;
                       $_SESSION['hrgenderUp']         = $gender;
                       $_SESSION['hrtel_personalUp']   = $tel_personal;
                       $_SESSION['hrtel_homeUp']       = $tel_home;
                       $_SESSION['hrnicUp']            = $nic;
                       $_SESSION['hrreligionUp']       = $religion;
                       $_SESSION['hrcivilstatusUp']    = $civilstatus;
                       $_SESSION['hrcatogaroyUp']      = $catogaroy;
                       $_SESSION['hrdevisionUp']       = $devId;
                       $_SESSION['hrteamUp']           = $teamId;
                       $_SESSION['hrephotoUp']         = $row['ephoto'];
                       $_SESSION['hrminimum_eduUp']    = $eduId;
                       $_SESSION['hrsportsUp']         = $sports;
                       $_SESSION['hrextra_eduUp']      = $extra_edu;
                       $_SESSION['hre_dojUp']          = $e_doj;
                       $_SESSION['hrother_companyUp']  = $other_company; 
                       $_SESSION['hroccupationUp']     = $occupation; 
                       $_SESSION['hretime_periodUp']   = $time_period;
                       $_SESSION['hrremarksUp']        = $remarks;
                    ...
                    while($row1= mysqli_fetch_assoc($sql_selectSkill)){
                      ...
                      //For Update Skill Drop DropDown Box.
                       ...
                       $piUpdate = $row1['picot'];
                        ...
                        $_SESSION['hrover_lockUp']     = $olUpdate;
                        $_SESSION['hrflat_lockUp']     = $flUpdate;
                        $_SESSION['hrsingle_needleUp'] = $snUpdate;
                        $_SESSION['hrdouble_needleUp'] = $dnUpdate;
                        $_SESSION['hrbar_tackUp']      = $btUpdate;
                        $_SESSION['hrbutton_holeUp']   = $bhUpdate;
                        $_SESSION['hrbutton_attachUp'] = $baUpdate;
                        $_SESSION['hrpicotUp']         = $piUpdate; 
