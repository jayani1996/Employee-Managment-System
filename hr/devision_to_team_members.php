...
<body>
	<div id="wrapper">
        ...
        if(isset($_GET['team_id'])){
            ...
            $_SESSION['hrteam_id'] = $_GET['team_id'];
            ?>
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12 text-center">
                      <h3 style="color:green;">
                        ...
                        <strong><?php echo $divNa; ?></strong>
                        <strong style="color:red;">&nbsp;/&nbsp;</strong>
                        <span style="color:black;"><?php echo $teamNa; ?>&nbsp;&nbsp;(Members)</span>
                      </h3> 
                    </div>
                </div><!--row-->
                <hr/>
                <?php 
                    ...
                    $sqlSelect = "SELECT * FROM 
                                                `employee`
                                           WHERE            
                                                `team` = '$teamId' AND `devision`= '$devId1' OR `devision`= '$devId2'
                                           ORDER By 
                                                `emp_id` 
                                           ASC ";
                ...
                <div class="row"> 
                    <div class="col-md-2">
                        <div class="form-group">
                           <a href="devision_to_team.php?dev_id=<?php 
                           ...
                           } ?>" class="btn btn-primary">Back to teams</a>
                        </div>
                    </div>
                      ...
                      <thead>
                        ...
                        ?>
                              ...
                              <tr>
                                ...
                                <td class="text-center"><a href="devision_tm_view.php?emp_id=<?php echo $emp_id; ?>" class="btn btn-primary btn-xs">View</a></td>
