  ...
  <nav class="navbar navbar-default navbar-cls-top" role="navigation" style="margin-bottom: 0">
    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            ...
            if($_GET['emp_id']){
            $dev_id  = $_SESSION['hrdev_id'];
            $teamId  =  $_SESSION['hrteam_id'];
            $emp_id = $_GET['emp_id'];
            $moreSQL  = "SELECT * FROM `employee` WHERE `emp_id` = '$emp_id'";
            $moreQuery = mysqli_query($con, $moreSQL);
            $moreNfRows  = mysqli_num_rows($moreQuery);
            $moreRow= mysqli_fetch_assoc($moreQuery);
                   ...
                   if($moreRow['ephoto'] == "noimage.png"){
                    $image = "../images/employee/noimage/".$moreRow['ephoto'];
                   }else{
                    $image = "../images/employee/".$moreRow['ephoto'];
                   }
                   //Educational Details
          ...
          <div id="page-inner">
            <div class="row">
              <div class="col-md-12 col-lg-12 text-center">
                <h3>
                  ...
                  <strong style="color:green"><?php echo $divNa; ?></strong><strong style="color:red">&nbsp;/&nbsp;</strong><span><?php echo $teamNa; ?></span>
                </h3>
              </div>
            </div>
            <hr>
            <div class="row">
               <div class="col-md-2 col-lg-2">
                  <a href="devision_to_team_members.php?team_id=<?php echo $teamId; ?>" class="btn btn-primary">Back to list</a>
               </div>
                ...
                <table class="table table-bordered">
                  ...
                  <?php
                        ...
                        if($posId == 2 OR $posId == 3 OR $posId == 4 OR $posId == 5){
                          ...
                          $sql_supper ="SELECT * FROM `skill` WHERE `emp_id` = '$emp_id'";
                          $sql_supper_query = mysqli_query($con, $sql_supper);
                          while($row=mysqli_fetch_assoc($sql_supper_query)){
