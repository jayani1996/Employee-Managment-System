...
if($_GET['emp_id']){
           ...
           $trxnDtlid  = get_trxn_dtl_max();
            ...
            $select = "SELECT  * FROM delete_emp 
              ...
              $trxn_dtl = "INSERT INTO `trxn_dtl`
                                               ...
                                               VALUES 
                                                        ('$trxnDtlid','$trxnid',18,CURRENT_TIMESTAMP)";
              ...
              $sql_noti = "INSERT INTO `noti_employee`
                  ...
                  // For will recover Delete employess
                   ...
                   $employee = "INSERT INTO `employee`
                                                      ...
                                                      VALUES 
                                                      (
                                                      '$empId','$trxnDtlid','$epf_no','$posId','$ename','$address',
                                                      '$dob','$gender','$tel_personal','$tel_home',
                                                      '$nic','$devId','$teamId','$ephoto', '$eduId','$sports',
                                                      '$extra_edu','$e_doj', '$other_company','$occupation',
                                                      '$time_period','$remarks','$religion','$civilstatus','$catogaroy'
                                                      )";

       if ($con->query($sql_noti) ===TRUE AND $con->query($employee) ===TRUE) {
       ...
       if($posId =="2" OR $posId =="3" OR $posId =="4" OR $posId =="5"){
            ...
            if($con->query($sql_noti2) ===TRUE AND $con->query($sql_ins2) ===TRUE){
           		...
           		$deleteQuery = "DELETE FROM `delete_emp` WHERE `emp_id` = $empId";

				      $deleteSkill = "DELETE FROM `delete_skill` WHERE `emp_id` = $empId";


			if ($con->query($deleteQuery)===TRUE AND $con->query($deleteSkill)===TRUE ) {

					echo '<script language="javascript">';
					echo 'alert("employee Recovered.")';
					echo '</script>';
					...
					echo '<script language="javascript">';
					echo 'alert("employee Not Recovered.")';
					echo '</script>';
