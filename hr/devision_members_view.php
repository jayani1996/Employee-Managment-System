...
<body>
	<div id="wrapper">
        ...
        if(isset($_GET['dev_id'])){
            ...
            $dev_id      = $_GET['dev_id'];
            $_SESSION['hrdev_id'] = $_GET['dev_id']; 

            $sqlTeam      = "SELECT * FROM  `devision` WHERE `dev_id` = '$dev_id'";
            $sqlTeamQuery = mysqli_query($con, $sqlTeam);
            $row_1        = mysqli_fetch_assoc($sqlTeamQuery);
            $dev_id       = $row_1['dev_id'];
            $dev_name     = $row_1['dev_name'];
            ?>
         ...
         <div id="page-wrapper">
            <div id="page-inner">
                  <div class="row">
                   <div class="col-md-12 col-lg-12 text-center">
                     <h3>
                      ...
                      <strong style="color:green"><?php echo $dev_name; ?></strong>
                    </h3>
                  </div>
                </div><!--row-->
                <hr/>
                <?php 
                    ...
                    $sqlSelect = "SELECT * FROM  `employee` WHERE `devision` = '$dev_id' ORDER By `team` ASC ";
                     ...
                     <table class="table-bordered table table-striped table-hover" id="dataTables-example">
                        ...
                        ?>
                              <tr>
                                ...
                                <td class="text-center"><a href="devision_members_oneByone_view.php?emp_id=<?php echo $id; ?>" class="btn btn-primary btn-xs">View</a></td>
                              </tr>
