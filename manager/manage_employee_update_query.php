...
if(!isset($_SESSION['mangrSession'])){
        ...
        // $empId     = $_SESSION['employeeID'];
         $seteamid  = $_SESSION['team_id'];
         $sedev     = $_SESSION['devision'];
...
<div id="wrapper">
  ...
  <nav class="navbar navbar-default navbar-cls-top" role="navigation" style="margin-bottom: 0">
   ...
   if(($epf_noNob==$_POST['epf_no']) || ($chkpfno<>$_POST['epf_no'])){
       ...
       function get_trxn_dtl_max()
        ...
        $posIdNob         = $_SESSION['mpositionUp'];  
        $enameNob         = $_SESSION['menameUp'];  
        $addressNob       = $_SESSION['maddressUp'];  
        $dobNob           = $_SESSION['mdobUp'];  
        $genderNob        = $_SESSION['mgenderUp'];  
        $tel_plNob        = $_SESSION['mtel_personalUp'];  
        $tel_homeNob      = $_SESSION['mtel_homeUp'];  
        $nicNob           = $_SESSION['mnicUp'];
        $religionNob      = $_SESSION['mreligionUp'];
        $ciilstusNob      = $_SESSION['mcivilstatusUp'];
        $catgroyNob       = $_SESSION['mcatogaroyUp'];  
        $devIdNob         = $_SESSION['mdevisionUp'];  
        $teamIdNob        = $_SESSION['mteamUp'];  
        $imageNob         = $_SESSION['mephotoUp'];  
        $eduIdNob         = $_SESSION['mminimum_eduUp'];  
        $sportsNob        = $_SESSION['msportsUp'];  
        $extra_eduNob     = $_SESSION['mextra_eduUp'];  
        $e_dojNob         = $_SESSION['me_dojUp'];  
        $ocompanyNob      = $_SESSION['mother_companyUp'];   
        $occupationNob    = $_SESSION['moccupationUp'];  
        $time_periodNob   = $_SESSION['metime_periodUp'];  
        $remarksNob       = $_SESSION['mremarksUp']; 
  ...
  if($_SESSION['mpCheck'] == 2 OR $_SESSION['mpCheck'] == 3 OR $_SESSION['mpCheck'] == 4 OR $_SESSION['mpCheck'] == 5){

                      $olNob = $_SESSION['mover_lockUp'];
                      $flNob = $_SESSION['mflat_lockUp'];
                      $snNob = $_SESSION['msingle_needleUp'];
                      $dnNob = $_SESSION['mdouble_needleUp'];
                      $btNob = $_SESSION['mbar_tackUp'];
                      $bhNob = $_SESSION['mbutton_holeUp'];
                      $baNob = $_SESSION['mbutton_attachUp'];
                      $piNob = $_SESSION['mpicotUp'];
        ...
        if($_SESSION['mpCheck'] <> 2 AND $_SESSION['mpCheck'] <> 3 AND $_SESSION['mpCheck'] <> 4 AND $_SESSION['mpCheck'] <> 5){

           $value  = $_SESSION['mpCheck'];
        } else{
        ...
        if( ($_SESSION['mpCheck']== $value AND ( $_POST['position']== 2 OR 
                                                 $_POST['position']== 3 OR 
                                                 $_POST['position']== 4 OR 
                                                 $_POST['position']== 5 ))  ) {
     ...
     //  }
       ...
       if($oSRow['emp_id']==$empId){
            ...
            $SQLCheck = "UPDATE `skill` SET 
             ...
             if($_FILES && $_FILES["file"]["size"] < $FileSize) {
                  ...
                  if("../images/employee/noimage/noimage.png"!==$_SESSION['moldImageName']){

                 
                     file_exists($_SESSION['moldImageName']);
                      unlink($_SESSION['moldImageName']);
                  }
      ...
      if ($con->query($SUpdate)===TRUE) {
        ...
        if(($_SESSION['mpCheck'] == 2 AND $_POST['position']== 2) OR
           ($_SESSION['mpCheck'] == 3 AND $_POST['position']== 3) OR
           ($_SESSION['mpCheck'] == 4 AND $_POST['position']== 4) OR 
           ($_SESSION['mpCheck'] == 5 AND $_POST['position']== 5)){
                ...
                //Notification Add employee
                  ...
                  $sqlAfterInt = "INSERT INTO `noti_employee`  (
                    ...
                    if ($con->query($sqlAfterInt)===TRUE) {
                      ...
                      echo "<script type='text/javascript'>window.location.href = 'manage_teams.php?team_id=$seteamid&&devision=$sedev';</script>";
              ...
              <div class="row">
               <div class="col-md-2">
                  <a href="manage_employee_update.php?update=<?php echo $empId; ?>" class="btn btn-primary btn-block">Back to form</a>
               </div>
                 <div class="col-md-8 text-center">
                    <h1>Dear Admin &nbsp;<strong><?php echo $_SESSION['mangrSession']; ?></strong></h1>
