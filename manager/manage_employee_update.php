        ...
        <div class="sidebar-collapse">
            ...
            if($numOfRows >0)
            {
                while($row= mysqli_fetch_assoc($sql_select)){
                       ...
                       $_SESSION['mpCheck'] = $row['position'];
                       $_SESSION['memployeeID']   = $row['emp_id'];
                       $eid          = $row['emp_id'];
                       $epf_no       = $row['epf_no']; 
                       $posId        = $row['position'];
                       $ename        = $row['ename'];
                    ...
                    if($row['ephoto'] == "noimage.png"){
                      ...
                      $_SESSION['moldImageName'] ="../images/employee/noimage/".$row['ephoto'];
                     }else{

                      $image = "../images/employee/".$row['ephoto'];
                      
                      $_SESSION['moldImageName']  = "../images/employee/".$row['ephoto'];
                      ...
                      $days   = floor(($diff - $years * 365*60*60*24 - $months*30*60*60*24)/ (60*60*24));
                       ...
                       $_SESSION['mepf_noUp']         = $epf_no; 
                       $_SESSION['mpositionUp']       = $posId;
                       $_SESSION['menameUp']          = $ename;
                       $_SESSION['maddressUp']        = $address;
                       $_SESSION['mdobUp']            = $dob;
                       $_SESSION['mgenderUp']         = $gender;
                       $_SESSION['mtel_personalUp']   = $tel_personal;
                       $_SESSION['mtel_homeUp']       = $tel_home;
                       $_SESSION['mnicUp']            = $nic;
                       $_SESSION['mreligionUp']       = $religion;
                       $_SESSION['mcivilstatusUp']    = $civilstatus;
                       $_SESSION['mcatogaroyUp']      = $catogaroy;
                       $_SESSION['mdevisionUp']       = $devId;
                       $_SESSION['mteamUp']           = $teamId;
                       $_SESSION['mephotoUp']         = $row['ephoto'];
                       $_SESSION['mminimum_eduUp']    = $eduId;
                       $_SESSION['msportsUp']         = $sports;
                       $_SESSION['mextra_eduUp']      = $extra_edu;
                       $_SESSION['me_dojUp']          = $e_doj;
                       $_SESSION['mother_companyUp']  = $other_company; 
                       $_SESSION['moccupationUp']     = $occupation; 
                       $_SESSION['metime_periodUp']   = $time_period;
                       $_SESSION['mremarksUp']        = $remarks;
  ...
  <div id="page-inner">
    ...
    <div class="row">
        <div class="col-md-2 col-lg-2">
          <a href="manage_teams.php?team_id=<?php echo $seteamid; ?>&amp;devision=<?php echo $sedev;?>" class="btn btn-primary">Back to list</a>
        </div>
                    ...
                    while($row1= mysqli_fetch_assoc($sql_selectSkill)){
                      ...
                      //For Update Skill Drop DropDown Box.
                       ...
                       $piUpdate = $row1['picot'];
                        ...
                        $_SESSION['mover_lockUp']     = $olUpdate;
                        $_SESSION['mflat_lockUp']     = $flUpdate;
                        $_SESSION['msingle_needleUp'] = $snUpdate;
                        $_SESSION['mdouble_needleUp'] = $dnUpdate;
                        $_SESSION['mbar_tackUp']      = $btUpdate;
                        $_SESSION['mbutton_holeUp']   = $bhUpdate;
                        $_SESSION['mbutton_attachUp'] = $baUpdate;
                        $_SESSION['mpicotUp']         = $piUpdate; 
